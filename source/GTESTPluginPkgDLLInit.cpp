...
// for first letter.
namespace GTESTPluginpkgdllinit {
  void __fastcall PACKAGE Register() {
    RegisterPackageWizard(new TGTESTPluginWizard("TGTESTPluginWizard"));
  }
}
#else
// For DLLs...
  ...
  TWizardTerminateProc&)
{
  ...
  RegisterWizard(new TGTESTPluginWizard("TGTESTPluginWizard"));
  return true;
}
#endif
